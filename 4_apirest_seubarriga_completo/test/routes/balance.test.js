...
// const TOKEN = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTAxMDAsIm5hbWUiOiJVc2VyICMzIiwibWFpbCI6Im5ld3VzZXIzQG1haWwuY29tIn0.O1RY9N7Li1oy_hs2comWhOPJjXiDwKpKNeNVekxPrlE';
// const TOKEN_GERAL = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTAxMDIsIm5hbWUiOiJVc2VyICM1IiwibWFpbCI6Im5ld3VzZXI1QG1haWwuY29tIn0.Gtz9aNcsVpm5qwoN5xi0oEC7zfOVRF8IuUklgRaiHnU';
...
describe('Ao calcular o saldo do usuário...', () => {
  test('Deve retornar apenas as contas com alguma transação', () => {
    return request(app).get(MAIN_ROUTE)
      ...
      .then((res) => {
          console.log('\tDeve retornar apenas as contas com alguma transação: ', res.body);
    ...
    return request(app).post(ROUTE_TRANSACTION)
      ...
      .then(() => {
        return request(app).get(MAIN_ROUTE)
          .set('authorization', `bearer ${TOKEN}`)
          .then((res) => {
              console.log('\tDeve adicionar valores de entrada: ', res.body);
            expect(res.status).toBe(200);
